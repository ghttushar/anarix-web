...
export const MOCK_DECISIONS: Decision[] = [
  ...
  // ————— MORNING BRIEF (overnight, before 8am today) —————
  {
    ...
    source: "anarix",
    sourceRef: { label: "Buybox monitor · SKU-A17", ts: todayAt(3, 12) },
    valueCents: 186_000,
    valueKind: "at_risk",
    cadence: "weekly",
  ...
  },
  {
    ...
    source: "anarix",
    sourceRef: { label: "Budget monitor · Evergreen SP", ts: todayAt(4, 40) },
    valueCents: 42_000,
    valueKind: "gain",
    cadence: "monthly",
    valueCaption: "monthly reclaimable spend",
  ...
  },
  {
    ...
    source: "anarix",
    sourceRef: { label: "CS monitor · returns", ts: todayAt(5, 15) },
    valueCents: 88_000,
    valueKind: "cost",
    cadence: "one_time",
  ...
  },
  {
    ...
    source: "anarix",
    sourceRef: { label: "Inventory monitor · SKU-B12", ts: todayAt(6, 5) },
    valueCents: 120_000,
    valueKind: "at_risk",
    cadence: "monthly",
  ...
  },
  {
    ...
    source: "anarix",
    sourceRef: { label: "Review monitor · SKU-A22", ts: todayAt(1, 30) },
    valueCents: 24_000,
    valueKind: "at_risk",
    cadence: "monthly",
